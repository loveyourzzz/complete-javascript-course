...
// const msg = "I'm " + firstName + ', a ' + age + ' year old ' + job + '!'
// console.log(msg)

// const msgNew = `I'm ${firstName}, a ${age} year old ${job}!`
// console.log(msgNew)

// console.log(`Just a regular string...`) // Always use `...`
...
// 	console.log('Ryan is able to drive!')
// } else {
...
// const firstName = 'Ryan'
// console.log(`I'm ${firstName}, ${2023 - 2000} years old.`)
