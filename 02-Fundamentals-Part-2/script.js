...
// console.log(yearsUntilRetirement(1975, 'Dad'))
...
// console.log(yearsUntilRetirement(2000, 'Ryan'))
// console.log(yearsUntilRetirement(1955, 'Grandma'))
...
// const Ryan = [firstName, 'Su', 2023 - 2000, 'student', friends]
// console.log(Ryan)
...
// const ryanArray = ['Ryan', 'Su', 2023 - 2000, 'Student', ['Michael', 'Peter', 'Steven']]
...
// ryan.location = 'China'
// ryan['twitter'] = '@loveyourzzz'
// console.log(ryan)

// Challenge
// "Ryan has 3 friends, and his best friend is called Michael."
...
// 	getSummary: function () {
// 		return `${this.firstName} is a ${this.calcAge()}-year old ${ryan.job}, and he has ${this.hasDriversLicense ? 'a' : 'no'} driver's license.`
// 	},
// }
...
// Challenge
// "Ryan is a 46-year old Student, and he has a driver's license"
...
// const ryan = ['Ryan', 'Su', 2023 - 2000, 'Student', ['Michael', 'Peter', 'Steven'], true]
// const types = []
